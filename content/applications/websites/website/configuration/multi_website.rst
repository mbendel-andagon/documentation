...
assigned sales team, etc. They can also :ref:`share contents and pages
...
.. note::
   ...
   **Forum**, **Blog**, etc.) and their related pages (e.g., **Forum**) are also available on the
...
.. note::
   ...
   current one. If the page you are currently viewing does not exist on the other website, you will
   be redirected to a 404 error page. Once redirected, click :guilabel:`Create page` to create a new
   page.
...
.. note::
   ...
   - In a :doc:`multi-company environment <../../../general/users/companies>`, each website can be
     ...
     jobs, events, etc.) is displayed on the website. To display company-specific data, set the
     desired company in the :guilabel:`Company` field.
